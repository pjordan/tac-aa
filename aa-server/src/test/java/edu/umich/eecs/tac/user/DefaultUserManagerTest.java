...
public class DefaultUserManagerTest {
    ...
    public void setup() {
        ...
        userManager = new DefaultUserManager(retailCatalog, transitionManager, queryManager, viewManager, populationSize, random);
    }

    @Test
    public void testConstuctor() {
        assertNotNull(userManager);
        assertNotNull(new DefaultUserManager(retailCatalog, transitionManager, queryManager, viewManager, populationSize));
    }

    @Test(expected = NullPointerException.class)
    public void testConstuctorRetailCatalogNull() {
        new DefaultUserManager(null, transitionManager, queryManager, viewManager, populationSize);
    }

    @Test(expected = NullPointerException.class)
    public void testConstuctorTransitionManagerNull() {
        new DefaultUserManager(retailCatalog, null, queryManager, viewManager, populationSize);
    }

    @Test(expected = NullPointerException.class)
    public void testConstuctorQueryManagerNull() {
        new DefaultUserManager(retailCatalog, transitionManager, null, viewManager, populationSize);
    }

    @Test(expected = NullPointerException.class)
    public void testConstuctorViewManagerNull() {
        new DefaultUserManager(retailCatalog, transitionManager, queryManager, null, populationSize);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstuctorNegativePopulationSize() {
        new DefaultUserManager(retailCatalog, transitionManager, queryManager, viewManager, -1);
    }

    @Test(expected = NullPointerException.class)
    public void testConstuctorRandomNull() {
        new DefaultUserManager(retailCatalog, transitionManager, queryManager, viewManager, populationSize, null);
    }

...
/**
 * The config proxy gives a reduced view of the {@link se.sics.isl.util.ConfigManager ConfigManager} properties, such as those given by a {@link edu.umich.eecs.tac.sim.Builtin Builtin} agent.
 *

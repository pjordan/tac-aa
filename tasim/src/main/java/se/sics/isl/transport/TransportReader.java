...
public abstract class TransportReader
{
  ...
  protected String getTransportableClass(String nodeName) throws ParseException
  {
    ...
    if (context == null)
    {
      throw new ParseException("no context for node " + nodeName, getPosition());
    }
    ...
    throw new ParseException("no node named " + nodeName + " in context " + context.getName(),
        getPosition());
  }
  ...
  protected Transportable createTransportable(String className) throws ParseException
  {
    ...
    {
      throw (ParseException) new ParseException("could not create transportable of type '"
          + className + '\'', getPosition()).initCause(e);
    }
  }
  ...
  public abstract boolean nextNode(String name, boolean isRequired) throws ParseException;
  ...
  protected abstract String getAttribute(String name, String defaultValue, boolean isRequired)
  ...
  protected int getAttributeAsInt(String name, int defaultValue, boolean isRequired)
      throws ParseException
  {
  ...
  protected long getAttributeAsLong(String name, long defaultValue, boolean isRequired)
      throws ParseException
  {
    String value = getAttribute(name, null, isRequired);
    if (value != null)
  ...
  protected float getAttributeAsFloat(String name, float defaultValue, boolean isRequired)
      throws ParseException
  {
    String value = getAttribute(name, null, isRequired);
    if (value != null)

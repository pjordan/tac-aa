 ...
 */
public class SalesReport extends
        AbstractQueryKeyedReportTransportable<SalesReport.SalesReportEntry> {
    ...
    public void setConversionsAndRevenue(Query query, int conversions,
                                         double revenue) {
        lockCheck();
    ...
    public void setConversionsAndRevenue(int index, int conversions,
                                         double revenue) {
        lockCheck();
        SalesReportEntry entry = getEntry(index);
        entry.setConversions(conversions);
    ...
    public static class SalesReportEntry extends AbstractQueryEntry {
        ...
        public String toString() {
            return String.format("(%s conv: %d rev: %f)", getQuery(),
                    conversions, revenue);
        }
    }
}

 ...
 * {@link edu.umich.eecs.tac.props.KeyedEntry keyed entries} with supporting methods for interacting entries
...
public abstract class AbstractKeyedEntryList<T, S extends KeyedEntry<T>> extends AbstractTransportableEntryListBacking<S> implements Iterable<T> {
    ...
    /**
     * Returns <code>true</code> if the key is in the list and <code>false</code> otherwise.
     *
    ...
    /**
     * Adds a new key to the list.  The {@link #createEntry} method creates the new entry with the specified key.
     *

...
/**
 * This class provides a skeletal implementation of a list of transportables.  The class if backed by an
 * {@link ArrayList}.
 *
...
public abstract class AbstractTransportableEntryListBacking<S extends Transportable> extends AbstractTransportable {
    ...
    /**
     * Removes the entry at the specified index in this list. Shifts any subsequent entries to the left (subtracts one
     ...
     * @return the index of the new entry. <code>-1</code> if the entry was not added.
     *
     * @throws IllegalStateException if the object is locked
     */
    ...
    /**
     *
     * Returns class of the entries.  The {@link Class#getSimpleName()} simple name} of the class will determine
     * how the entries are read in by the {@link TransportReader}.  Implementing classes should return the class of

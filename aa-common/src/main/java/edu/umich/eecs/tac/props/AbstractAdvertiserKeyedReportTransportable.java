 ...
 * {@link edu.umich.eecs.tac.props.AdvertiserEntry advertiser entries} with supporting methods for interacting entries
 * specified by a given advertiser. 
 *
...
public abstract class AbstractAdvertiserKeyedReportTransportable <T extends AdvertiserEntry> extends AbstractKeyedEntryList<String,T> {
    ...
    /**
     * Adds a new key to the list.  The {@link #createEntry} method creates the new {@link AdvertiserEntry entry}
     * with the specified advertiser.  This method delegates to {@link #addKey(Object)}.
     *
     * @param advertiser the advertiser used to add the new {@link AdvertiserEntry advertiser entry}.
     *
    ...
    /**
     * Returns <code>true</code> if the advertiser key is in the list and <code>false</code> otherwise. This method
     * delegates to {@link #containsKey(Object)}.
     *
